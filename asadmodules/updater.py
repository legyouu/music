...
@Client.on_message(command(["upndate", f"updbate@{BOT_USERNAME}"]) & ~filters.edited)
@sudo_users_only
async def update_repo(_, message: Message):
    ...
    if update_avail:
        ...
        return
    await msg.edit("bot is **up-to-date** with [main](https://github.com/JAI6H)", disable_web_page_preview=True)
